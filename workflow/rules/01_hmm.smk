...
rule polar_plots:
    input:
        rules.run_hmm.output
    output:
        polar_all_dge = "book/figs/polar_plots/{interval}/{variables}/{n_states}/polar_all_dge.png",
        polar_all_sge = "book/figs/polar_plots/{interval}/{variables}/{n_states}/polar_all_sge.png",
    log:
        os.path.join(
            config["workdir"],
