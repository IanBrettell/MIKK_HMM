...
rule get_manhattan_gcta_state_freq:
    ...
    output:
        ...
        sig = "results/{variables}/{interval}/{n_states}/{bin_length}/{cov}/{dge_sge}/{transformation}/{assay}/{state}_{covars}.tsv"
    log:
        os.path.join(
            config["workdir"],
...
#        csv = os.path.join(
#            config["workdir"],
#            "gcta/mlma_loco/fisher_method/hdrr/{variables}/{interval}/{n_states}/{bin_length}/{cov}/{dge_sge}/{transformation}/{assay}/{covars}/{adj_method}.csv"
#        ),
#    log:
#        os.path.join(
#            config["workdir"],
#            "logs/apply_fisher_method/hdrr/{variables}/{interval}/{n_states}/{bin_length}/{cov}/{dge_sge}/{transformation}/{assay}/{covars}/{adj_method}.log"
#        ),    
#    params:
...
#        config["R_4.2.0"]
#    script:
#        "../scripts/apply_fisher_method.R"
#
#rule get_state_freq_mirror_man_fisher:
#    input:
#        dge = expand(os.path.join(
#            config["workdir"],
#            "gcta/mlma_loco/fisher_method/hdrr/{{variables}}/{{interval}}/{{n_states}}/{{bin_length}}/{{cov}}/{dge_sge}/{{transformation}}/{{assay}}/{{covars}}/{{adj_method}}.csv"
#            ),
#                dge_sge = "dge"
#        ),
#        sge = expand(os.path.join(
#            config["workdir"],
#            "gcta/mlma_loco/fisher_method/hdrr/{{variables}}/{{interval}}/{{n_states}}/{{bin_length}}/{{cov}}/{dge_sge}/{{transformation}}/{{assay}}/{{covars}}/{{adj_method}}.csv"
#            ),
#                dge_sge = "sge"
#        ),
#    output:
#        man = "book/figs/gcta/hdrr/state_freq_fisher_method/{variables}/{interval}/{n_states}/{bin_length}/{cov}/{transformation}/{assay}/{covars}/{adj_method}.png",
#        sig = "results_sf_fisher_method/{variables}/{interval}/{n_states}/{bin_length}/{cov}/{transformation}/{assay}/{covars}/{adj_method}.tsv"
#    log:
#        os.path.join(
#            config["workdir"],
#            "logs/get_state_freq_mirror_man_fisher/hdrr/{variables}/{interval}/{n_states}/{bin_length}/{cov}/{transformation}/{assay}/{covars}/{adj_method}.log"
#        ),    
#    params:
#        bin_length = "{bin_length}",
#        cov = "{cov}",
...
#        config["R_4.1.3"]
#    script:
#        "../scripts/get_manhattan_gcta_fisher_mirror.R"